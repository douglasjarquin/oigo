...
The storage implementation source SHA for this handoff is `7c5c50a1fd4cb3fdea7ba99d710daad4b5b26b4a`.
...
| Menu bar, Settings, and onboarding expose persistent storage health and Retry Storage behavior | INCONCLUSIVE | Exact bundle path: `/tmp/oigo-issue86-xcode-final8-zuvz40/Build/Products/Release/Oigo.app` at `7c5c50a1fd4cb3fdea7ba99d710daad4b5b26b4a` | Computer Use Accessibility and Screen Recording permissions were unavailable, so no AX tree or screenshot is treated as proof. |
