...
The current candidate SHA is `41338e314f074bdc86cc51b90cd97aea2c231b9e`.
...
| Menu bar, Settings, and onboarding expose persistent storage health and Retry Storage behavior | INCONCLUSIVE | Exact bundle path: `/tmp/oigo-issue86-xcode-final-GzkixQ/Build/Products/Release/Oigo.app` at `41338e314f074bdc86cc51b90cd97aea2c231b9e` | Computer Use Accessibility and Screen Recording permissions were unavailable, so no AX tree or screenshot is treated as proof. |
