...
| --- | --- | --- | --- | --- |
| H82-01 Press and hold | PASS: one keyboard-owned start | INCONCLUSIVE until exact bundle receives separate key-down and key-up edges | `.omo/evidence/issue-82/task-11-final-verification.log`, `.omo/evidence/issue-82/task-12-native-prerequisites-final.log` | Another application remains frontmost before, during, and after the operation. |
