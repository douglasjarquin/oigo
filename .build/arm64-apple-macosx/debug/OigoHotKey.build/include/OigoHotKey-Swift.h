...
#ifndef OIGOHOTKEY_SWIFT_H
#define OIGOHOTKEY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OigoHotKey",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSCoder;
@class NSEvent;
SWIFT_CLASS("_TtC10OigoHotKey23ShortcutRecorderControl")
