...
#ifndef OIGOPRESENTATION_SWIFT_H
#define OIGOPRESENTATION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OigoPresentation",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSCoder;
@class NSBundle;
SWIFT_CLASS("_TtC16OigoPresentation25OigoPopoverViewController")
@interface OigoPopoverViewController : NSViewController
