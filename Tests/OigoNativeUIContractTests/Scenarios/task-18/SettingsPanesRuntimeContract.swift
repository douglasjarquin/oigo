...
enum SettingsPanesRuntimeContract {
    ...
    final class Delegate: NSObject, NSApplicationDelegate {
        ...
        private func base(_ factory: Factory) throws {
            ...
            let ids = ["pane.general", "section-dictation", "section-dictionary", "section-data-privacy", "section-permissions", "shortcut-recorder", "launch-at-login", "volatile-preview", "default-mode", "microphone-input", "input-channel", "dictation-language", "audio-retention", "keep-audio", "dictionary-add", "dictionary-canonical", "dictionary-search", "dictionary-add-alias", "dictionary-result", "dictionary-toggle", "dictionary-delete", "dictionary-starter-terms", "dictionary-preview", "refresh-permissions", "open-microphone-settings", "open-accessibility-settings", "open-history", "open-data-folder", "delete-all-history", "export-diagnostics"]
